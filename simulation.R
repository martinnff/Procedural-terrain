...
points = data.frame(x=runif(200000,0,1),
                    y=runif(200000,0,1))

# get the height of each point as a sum of various
# layers of perlin noise in diferent scales
noise1 = perlin(points,grid1)  
noise2 = perlin(points,grid2)
noise3 = perlin(points,grid3)
